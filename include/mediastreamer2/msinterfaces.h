...
#define MS_AUDIO_DEVICE_START_SPEAKING \
	MS_FILTER_METHOD(MSFilterAudioCaptureInterface, 7, uint32_t)
#define MS_AUDIO_DEVICE_STOP_SPEAKING \
	MS_FILTER_METHOD(MSFilterAudioCaptureInterface, 8, uint32_t)
