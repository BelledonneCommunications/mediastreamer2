...
#define MS_VIDEO_SWITCHER_SET_AS_LOCAL_MEMBER                                                                          \
	MS_FILTER_METHOD(MS_VIDEO_SWITCHER_ID, 1, MSVideoConferenceFilterPinControl)
...
/**Events raised by the switcher when it needs to receive a key frame in order to complete the switch to new input
 * source*/
