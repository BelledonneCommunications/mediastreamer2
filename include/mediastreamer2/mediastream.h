...
MS2_PUBLIC void video_stream_enable_retransmission_on_nack(VideoStream *stream);
MS2_PUBLIC void video_stream_set_retransmission_on_nack_max_packet(VideoStream *stream, unsigned int max);
MS2_PUBLIC void video_stream_disable_retransmission_on_nack(VideoStream *stream);
