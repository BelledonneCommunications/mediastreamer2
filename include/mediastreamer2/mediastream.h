...
struct _VideoStream
{
	...
	bool_t fallback_to_dummy_codec; /**< if TRUE, enable fallback to dummy codec when the requested one is not supported - used to build a videostream in the conference server */
