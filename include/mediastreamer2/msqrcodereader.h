...
#define MS_QRCODE_READER_STOP_SEARCH MS_FILTER_METHOD_NO_ARG(MS_QRCODE_READER_ID, 1)
#define MS_QRCODE_READET_SET_DECODER_RECT MS_FILTER_METHOD(MS_QRCODE_READER_ID, 2, MSRect)
