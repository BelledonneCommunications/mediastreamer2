...
typedef void (*resolveGlBufferData)(GLenum target, GLsizeiptr size, const void *data, GLenum usage);
typedef void (*resolveGlBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const void *data);
