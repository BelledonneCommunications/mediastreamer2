...
typedef struct _MSVideoRouterPinControl{
	int pin;
	int enabled;
}MSVideoRouterPinControl;
...
#define MS_VIDEO_ROUTER_SET_AS_LOCAL_MEMBER MS_FILTER_METHOD(MS_VIDEO_ROUTER_ID,2,MSVideoRouterPinControl)
