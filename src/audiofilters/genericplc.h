...
/* define in ms the maximum duration of PLC(after wich the output will be 0), and after how long we start decreasing the
 * output volume to reach 0 at MAX_PLC_LEN */
