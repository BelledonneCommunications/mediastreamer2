...
media_status_t AMediaCodec_configure(AMediaCodec *codec, const AMediaFormat* format, BCTBX_UNUSED(ANativeWindow* surface), BCTBX_UNUSED(AMediaCrypto *crypto), uint32_t flags) {
	JNIEnv *env = ms_get_jni_env();
