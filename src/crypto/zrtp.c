...
static void set_key_agreement_suites(bzrtpContext_t *ctx, const MSZrtpKeyAgreement *keyAgreements, const MsZrtpCryptoTypesCount count) {
	...
	for (i=0; i < count; i++) {
		switch (keyAgreements[i]) {
			...
			case MS_ZRTP_KEY_AGREEMENT_SIK1:			bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_SIK1; break;
			case MS_ZRTP_KEY_AGREEMENT_SIK2:			bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_SIK2; break;
			case MS_ZRTP_KEY_AGREEMENT_SIK3:			bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_SIK3; break;
			case MS_ZRTP_KEY_AGREEMENT_K255_KYB512:     bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_K255_KYB512; break;
			case MS_ZRTP_KEY_AGREEMENT_K255_SIK434:     bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_K255_SIK434; break;
			case MS_ZRTP_KEY_AGREEMENT_K448_KYB1024:    bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_K448_KYB1024; break;
			case MS_ZRTP_KEY_AGREEMENT_K448_SIK751:     bzrtpKeyAgreements[bzrtpCount++] = ZRTP_KEYAGREEMENT_K448_SIK751; break;
		}
	}
...
MSZrtpKeyAgreement ms_zrtp_key_agreement_from_string(const char* str) {
	...
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_SIK1);
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_SIK2);
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_SIK3);
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_K255_KYB512);
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_K255_SIK434);
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_K448_KYB1024);
	STRING_COMPARE_RETURN(str, MS_ZRTP_KEY_AGREEMENT_K448_SIK751);
...
const char* ms_zrtp_key_agreement_to_string(const MSZrtpKeyAgreement keyAgreement) {
	SWITCH_CRYPTO_ALGO(keyAgreement,\
		...
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_SIK1);\
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_SIK2);\
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_SIK3);\
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_K255_KYB512);\
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_K255_SIK434);\
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_K448_KYB1024);\
		CASE_RETURN_STRING(MS_ZRTP_KEY_AGREEMENT_K448_SIK751);\
	);
}
