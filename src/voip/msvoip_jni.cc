...
JNIEXPORT void JNICALL Java_org_linphone_mediastream_Factory_setDeviceInfo(JNIEnv *env, BCTBX_UNUSED(jobject obj),
...
JNIEXPORT jint JNICALL Java_org_linphone_mediastream_Factory_getDeviceFlags(BCTBX_UNUSED(JNIEnv *env), BCTBX_UNUSED(jobject obj), jlong factoryPtr) {
